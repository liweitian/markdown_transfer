...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> _generateWord() async {
    ...
    try {
      final file = await WordUtils.generateWordFromMarkdown(_contentController.text);
  ...
  Future<void> _generateXlsx() async {
    ...
    try {
      final file = await XlsxUtils.generateXlsxFromMarkdown(_contentController.text);
  ...
  Future<void> _generatePPTX() async {
    ...
    try {
      final file = await PPTXUtils.generatePPTXFromMarkdown(_contentController.text);
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            // _buildInputSection('Title / Prompt', _titleController),
            // const SizedBox(height: 16),
            Expanded(
              child: _buildInputSection('Main Content', _contentController),
            ),
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      _buildFormatButton(
                          Icons.description_outlined, 'Word', _generateWord),
                      _buildFormatButton(
                          Icons.picture_as_pdf_outlined, 'PDF', _generatePDF),
                      _buildFormatButton(
                          Icons.slideshow_outlined, 'Slides', _generatePPTX),
                      _buildFormatButton(
                          Icons.table_chart_outlined, 'Sheet', _generateXlsx),
                      _buildFormatButton(Icons.image_outlined, 'Image', () {}),
                      _buildFormatButton(
