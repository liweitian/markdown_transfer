    ...
    try {
      ...
      if (context.mounted) {
        await Share.shareXFiles(
          [XFile(file.path)],
          text: 'PDF document generated by Transforma',
        );
      }
    } catch (e) {
  ...
  static Future<void> generateAndShareWord(String content, BuildContext context) async {
    ...
    try {
      ...
      if (context.mounted) {
        await Share.shareXFiles(
          [XFile(file.path)],
          text: 'Word document generated by Transforma',
        );
      }
    } catch (e) {
  ...
  static Future<void> generateAndShareExcel(String content, BuildContext context) async {
    ...
    try {
      ...
      if (context.mounted) {
        await Share.shareXFiles(
          [XFile(file.path)],
          text: 'Excel document generated by Transforma',
        );
      }
    } catch (e) {
  ...
  static Future<void> generateAndSharePowerPoint(String content, BuildContext context) async {
    ...
    try {
      ...
      if (context.mounted) {
        await Share.shareXFiles(
          [XFile(file.path)],
          text: 'PowerPoint document generated by Transforma',
        );
      }
    } catch (e) {
  ...
  static Future<void> generateAndShareText(String content, BuildContext context) async {
    ...
    try {
      ...
      if (context.mounted) {
        await Share.shareXFiles(
          [XFile(file.path)],
          text: 'Text document generated by Transforma',
        );
      }
    } catch (e) {
  ...
  static Future<void> generateAndSaveImage(
    ...
    try {
      ...
      if (result['isSuccess']) {
        ...
        final directory = await getApplicationDocumentsDirectory();
        final fileName = "transforma_${DateTime.now().millisecondsSinceEpoch}.png";
        final file = File('${directory.path}/$fileName');
